...
if not funcitons.find_link_and_click(driver, u'Обратная связь', 'feedback'):
...
if login not in functions.get_value('feedback-email'):
...
for text in ['OK', u'ОК']:
	try:
		driver.find_element_by_parital_link_text(text).click()
